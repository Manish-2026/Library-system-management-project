...
BEGIN
    ...
    value(p_return_id, p_issued_id, curdate(),v_isbn);

    -- Get isbn and book name for message
...
WHERE member_id in (SELECT 
                    ...
                    FROM issued_status
                    WHERE 
                        issued_date >= CURdate() - INTERVAL 22 month
                    );
...
SELECT * FROM issued_status;
CALL issue_book('IS159', 'C108', '978-0-553-29698-2', 'E104');
CALL issue_book('IS156', 'C108', '978-0-375-41398-8', 'E104');
SELECT * FROM return_status
WHERE return_book_isbn = '978-0-553-29698-2';
CALL add_return_record('RS140', 'IS158', 'Good');
